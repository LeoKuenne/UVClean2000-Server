<template>
  <router-link :to="'devices?device=' + device.serialnumber" class="cursor-default">
    <div>
      ...
      <div class="p-2 grid grid-cols-2 space-y-2 items-center">
        ...
        <div class="col-span-2 flex flex-col space-y-5 pb-5" v-if="currentLampStates.length !== 0">
          <div class="">
            <div class="flex justify-between">
